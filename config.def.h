...
static Key keys[] = {
	...
	{ MODKEY,                       XK_w,      spawn,          SHCMD("chromium --force-dark-mode") },
	{ MODKEY|ShiftMask,             XK_w,      spawn,          SHCMD("discord") },
	...
	{ MODKEY,                       XK_a,      spawn,          SHCMD("st ncmpcpp") },
	...
	{ MODKEY,                       XK_F6,     spawn,          SHCMD("pulsemixer --toggle-mute") },
	{ MODKEY,                       XK_F7,     spawn,          SHCMD("pulsemixer --change-volume -5") },
	{ MODKEY,                       XK_F8,     spawn,          SHCMD("pulsemixer --change-volume +5") },
	{ MODKEY,                       XK_F9,     spawn,          SHCMD("dmenurecord") },
	{ MODKEY,                       XK_F10,    spawn,          SHCMD("dmenurecord kill") },
	...
	{ MODKEY,                       XK_Print,  spawn,          SHCMD("maim ~/media/pics/screenshots/pic-full-$(date '+%y%m%d-%H%M-%S').png") },
